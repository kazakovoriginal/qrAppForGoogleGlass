 ...
 * capture.
 * Обрабатывает сообщения которые используются в устройстве, которая находится в стационарном состоянии
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        if (message.what == R.id.restart_preview) {
            ...
            //отредактированно/изменено



//            java.util.logging.Logger.getGlobal().info(result);
//
//            ClientConfig config = new DefaultClientConfig();
//            Client client = Client.create(config);
//            WebResource service = client.resource(UriBuilder.fromUri("http://192.168.1.71:8081/hello/string").build());
//            String str = "[{ \"name\": \"Андрей\", \"QR_ID\": 35, \"Query\": select * from }]";
//
//            ClientResponse response = service.type(MediaType.APPLICATION_FORM_URLENCODED_TYPE).post(ClientResponse.class, str);
