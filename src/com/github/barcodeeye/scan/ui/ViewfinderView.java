...
import com.example.qrApp.R;//com.github.barcodeeye.R;
import com.google.zxing.ResultPoint;
import com.google.zxing.ResultPointCallback;
import com.google.zxing.client.android.camera.CameraManager;

/**
 * This view is overlaid (наложение) on top of the camera preview. It adds the viewfinder
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            // Draw the opaque (непрозрачный) result bitmap over the scanning rectangle
