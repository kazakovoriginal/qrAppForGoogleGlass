    ...
    private static boolean shouldBeep(SharedPreferences prefs, Context activity) {
        ...
        if (shouldPlayBeep) {
            ...
            AudioManager audioService = (AudioManager) activity
                    .getSystemService(Context.AUDIO_SERVICE); //Системные службы, полученные с помощью этого API можно тесно связана с контекстом, в котором они получены
            ...
            if (audioService.getRingerMode() != AudioManager.RINGER_MODE_NORMAL) { //audioService.getRingerMode() - Returns the current ringtone mode.
